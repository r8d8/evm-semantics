...
proof_targets=${proof_dir}/sum-to-n-spec.k \
			...
			${proof_dir}/hkg/transfer3-spec.k  ${proof_dir}/hkg/transfer4-spec.k \
			...
			${proof_dir}/hkg/transferFrom3a-spec.k ${proof_dir}/hkg/transferFrom3b-spec.k ${proof_dir}/hkg/transferFrom3c-spec.k \
			${proof_dir}/hkg/transferFrom4a-spec.k ${proof_dir}/hkg/transferFrom4b-spec.k ${proof_dir}/hkg/transferFrom4c-spec.k \
